...
//             Acompanhe entradas, despesas fixas, cartões e gastos avulsos — com histórico permanente,
//             mês a mês.
//           </p>
//         </div>
...
//             <span className="font-medium text-[#1C1C19]">Por que Google?</span> Sem senhas para você
//             gerenciar e sessão criptografada via cookie. Apenas a allowlist permite acesso.
//           </div>
//         </div>
//       </div>
//     </div>
