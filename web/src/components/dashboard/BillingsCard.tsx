...
export default function BillingsCard({ billings, year, month, onChanged, summary }: BillingsCardProps) {
  ...
  const handleOpenChange = (next: boolean) => {
    if (!next && !overlayClickRef.current) return;
  ...
  return (
    <div className="">
      <div className="bg-white border border-[#EAE7E1] rounded-2xl p-4 sm:p-6 h-max">
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="font-medium text-[#1C1C19] truncate text-sm sm:text-base">{b.name}</div>
              ...
              <div className="flex items-center gap-3">
                <div className="font-display font-semibold text-[#1C1C19] text-sm sm:text-base tabular-nums">
